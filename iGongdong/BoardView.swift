...
class BoardView : UIViewController, UITableViewDelegate, UITableViewDataSource, HttpSessionRequestDelegate {
    ...
    private func loadCenterData() {
        ...
        if commId == "ing" {
            ...
            board = Board.init(title: "법인일정", boardId: "B221", type: GlobalConst.CAFE_TYPE_CAL, isNew: 0, isCal: 0)
            boardList.append(board!)
            ...
            boardList.append(board!)
            board = Board.init(title: "교사모집/구직", boardId: "B251", type: GlobalConst.CAFE_TYPE_CENTER, isNew: 0, isCal: 0)
            boardList.append(board!)
            board = Board.init(title: "조합원모집", boardId: "B261", type: GlobalConst.CAFE_TYPE_CENTER, isNew: 0, isCal: 0)
            boardList.append(board!)
            board = Board.init(title: "무터전소식", boardId: "B301", type: GlobalConst.CAFE_TYPE_CENTER, isNew: 0, isCal: 0)
            boardList.append(board!)
        } else {
